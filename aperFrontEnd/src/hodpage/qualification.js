...
class Qualification extends Component  {
  ...
  onSubmitAcademic = (e) => {
    ...
    console.log(this.state.token)
    const options={headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${this.state.token}`}};             
    axios.post(`${URL}/lecturer/academicQualifications`, formData, options)
      .then((response) => {
  ...
  onSubmitProfessional = (e) => {
    ...
    console.log(this.state.token)
    const options={headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${this.state.token}`}};             
    axios.post(`${URL}/lecturer/professionalQualifications`, formData, options)
      .then((response) => {
        if (response.status == 200) {
            console.log(response.data)
            this.getProfessionalQualification();
                ...
                <div className="box-body">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className="form-group">
                          ...
                          <input type="text" onChange={event =>this.setState({institution: event.target.value,})}
                      ...
                      <div className="col-md-2">
                        <div className="form-group">
                          ...
                          <input type="date" onChange={event =>this.setState({award_date: event.target.value,})} className="form-control" placeholder=" date"/>
                        </div>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-12 pull-right">
                      <input type="submit" className="btn btn-warning btn-outline pull-right " value="Add" />
                    </div>
                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <input type="text" onChange={event =>this.setState({profession: event.target.value,})}
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <input type="text" onChange={event =>this.setState({qualification: event.target.value,})}
                          className="form-control" placeholder="Last Name"/>
                        </div>
                      </div>
