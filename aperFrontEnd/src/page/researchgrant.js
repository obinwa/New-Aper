...
class ResearchGrant extends Component  {
  ...
  onSubmitResearch = (e) => {
    ...
    console.log(URL);
    console.log(this.state.token)
    const options={headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${this.state.token}`}};let url = `${URL}/lecturer/researchGrant`
    if(this.state.updateId){
       url = `${URL}/lecturer/researchGrant/${this.state.updateId}`
    }             
  ...
  getResearchGrant=()=>{   
    ...
    axios.get(`${URL}/lecturer/researchGrant`,options)
    .then( (response) => {
        if(response.data){         
          console.log(response.data)
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          ...
                          <input type="text" value={this.state.awarding_body}
