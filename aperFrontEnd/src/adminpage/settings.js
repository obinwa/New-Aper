...
class AdminLecturerSetting extends Component  {
  ...
  setUpdate = (pub)=>{
    ...
    this.setState({
        ...
        hod_start_time:moment(pub.hod_start_time).format("YYYY-MM-DD"),        
        hod_end_time:moment(pub.hod_end_time).format("YYYY-MM-DD"),
        dean_start_time:moment(pub.dean_start_time).format("YYYY-MM-DD"),        
      ...
      <div className="col-md-12">
        <div className="box">
          <div className="box-header with-border">
            <h3 className="box-title">General Setting Info</h3>
          </div>
          {/* <!-- /.box-header --> */}
            ...
            <div className="table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th>Hod Start Time</th>
                  <th>Hod End Time</th>
                  <th>Dean Start Time</th>
                  <th>Dean End Time</th>
                ...
                <div className="box-body">
                  ...
                  <form onSubmit={this.onSubmitResearch} className="form">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          <label>Hod Start Time</label>
                          <input type="date" value={this.state.hod_start_time}
                          onChange={event =>this.setState({hod_start_time: event.target.value,})}
                           className="form-control" placeholder="Institution"/>
                        </div>
                      </div>
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          <label>Dean Start Time</label>
                          <input type="date" value={this.state.dean_start_time}
                          onChange={event =>this.setState({dean_start_time: event.target.value,})}
                           className="form-control" placeholder="Institution"/>
                        </div>
                      </div>
...
export default AdminLecturerSetting;
